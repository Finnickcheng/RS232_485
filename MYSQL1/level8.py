...
def Send_LINE(Message):
    LineToken = '39KAiri0t7REhjGEtHSMPfZTlCF6z2DACDPTwaV5VH3'
...
def Send_Email(Temp):
    ...
    message["Cc"] = 'finnick37@gmail.com'  # 副本收件人1, 副本收件人2
    ...
    status = smtp.sendmail(from_addr, (to_addr + ['t10830b609@ntut.org.tw', 'nexstar1436@gmail.com']), msg)  # 加密文件，避免私密信息被截取
    DoneStatus = False
    if status == {}:
        DoneStatus = True
    smtp.quit()
...
with con.cursor() as cursor:
    ...
    #     TmpJson_NotifyCollectData = {'NotifyType': '', 'NotifylatFrom': '', 'NotifyTimeStamp': '', 'NotifyDateTime': ''}
    #     TrMessage = ''
    ...
    #         con.commit()
    #         TrMessage += '<tr>'
    #         TrMessage += '<th style="border: 1px solid #dddddd;text-align: center;padding: 8px;">' + value2['Name'] + '</th>'
    #         TrMessage += '<th style="border: 1px solid #dddddd;text-align: center;padding: 8px;">' + value2['Address'] + '</th>'
    #         TrMessage += '</tr>'
